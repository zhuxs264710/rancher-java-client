...
import io.rancher.model.enums.AdfsConfigAccessModeEnum;

public class AdfsConfig extends AbstractType {
    
    private AdfsConfigAccessModeEnum accessMode;
    ...
    public AdfsConfigAccessModeEnum getAccessMode() {
        return this.accessMode;
    }

    public void setAccessMode(AdfsConfigAccessModeEnum accessMode) {
