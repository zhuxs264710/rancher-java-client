...
import io.rancher.model.enums.OpenLdapConfigAccessModeEnum;

public class OpenLdapConfig extends AbstractType {
    
    private OpenLdapConfigAccessModeEnum accessMode;
    ...
    public OpenLdapConfigAccessModeEnum getAccessMode() {
        return this.accessMode;
    }

    public void setAccessMode(OpenLdapConfigAccessModeEnum accessMode) {
