package io.rancher.type.project.workload;

import java.util.List;
import java.util.Map;

import io.rancher.base.AbstractType;
import io.rancher.model.enums.WorkloadTransitioningEnum;
...
import io.rancher.type.cronjob.CronJobConfig;
import io.rancher.type.cronjob.CronJobStatus;
import io.rancher.type.docker.container.Container;
import io.rancher.type.kubernetes.HostAlias;
import io.rancher.type.kubernetes.daemonset.DaemonSetConfig;
import io.rancher.type.kubernetes.daemonset.DaemonSetStatus;
import io.rancher.type.kubernetes.deployment.DeploymentConfig;
import io.rancher.type.kubernetes.deployment.DeploymentStatus;
import io.rancher.type.kubernetes.job.JobConfig;
import io.rancher.type.kubernetes.job.JobStatus;
import io.rancher.type.kubernetes.pod.PodDNSConfig;
import io.rancher.type.kubernetes.replicaset.ReplicaSetConfig;
import io.rancher.type.kubernetes.replicaset.ReplicaSetStatus;
import io.rancher.type.kubernetes.replicationcontroller.ReplicationControllerConfig;
import io.rancher.type.kubernetes.replicationcontroller.ReplicationControllerStatus;
import io.rancher.type.kubernetes.statefulset.StatefulSetConfig;
import io.rancher.type.kubernetes.statefulset.StatefulSetStatus;
import io.rancher.type.kubernetes.volumes.Volume;

public class Workload extends AbstractType {
    ...
    private DaemonSetStatus daemonSetStatus;
    ...
    private StatefulSetConfig statefulSetConfig;
    
    private StatefulSetStatus statefulSetStatus;
    
    private String subdomain;
    
    private Integer terminationGracePeriodSeconds;
    
    private WorkloadTransitioningEnum transitioning;
    ...
    public CronJobConfig getCronJobConfig() {
        return this.cronJobConfig;
    }

    public void setCronJobConfig(CronJobConfig cronJobConfig) {
    ...
    public DaemonSetConfig getDaemonSetConfig() {
        return this.daemonSetConfig;
    }

    public void setDaemonSetConfig(DaemonSetConfig daemonSetConfig) {
      this.daemonSetConfig = daemonSetConfig;
    }
    
    public DaemonSetStatus getDaemonSetStatus() {
        return this.daemonSetStatus;
    }

    public void setDaemonSetStatus(DaemonSetStatus daemonSetStatus) {
    ...
    public void setReplicationControllerConfig(ReplicationControllerConfig replicationControllerConfig) {
    ...
    public void setReplicationControllerStatus(ReplicationControllerStatus replicationControllerStatus) {
    ...
    public StatefulSetConfig getStatefulSetConfig() {
        return this.statefulSetConfig;
    }

    public void setStatefulSetConfig(StatefulSetConfig statefulSetConfig) {
      this.statefulSetConfig = statefulSetConfig;
    }
    
    public StatefulSetStatus getStatefulSetStatus() {
        return this.statefulSetStatus;
    }

    public void setStatefulSetStatus(StatefulSetStatus statefulSetStatus) {
    ...
    public WorkloadTransitioningEnum getTransitioning() {
        return this.transitioning;
    }

    public void setTransitioning(WorkloadTransitioningEnum transitioning) {
