...
import io.rancher.model.enums.KeyCloakConfigAccessModeEnum;

public class KeyCloakConfig extends AbstractType {
    
    private KeyCloakConfigAccessModeEnum accessMode;
    ...
    public KeyCloakConfigAccessModeEnum getAccessMode() {
        return this.accessMode;
    }

    public void setAccessMode(KeyCloakConfigAccessModeEnum accessMode) {
