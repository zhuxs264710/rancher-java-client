...
import io.rancher.model.enums.FreeIpaConfigAccessModeEnum;

public class FreeIpaConfig extends AbstractType {
    
    private FreeIpaConfigAccessModeEnum accessMode;
    ...
    public FreeIpaConfigAccessModeEnum getAccessMode() {
        return this.accessMode;
    }

    public void setAccessMode(FreeIpaConfigAccessModeEnum accessMode) {
