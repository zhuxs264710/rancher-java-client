...
import io.rancher.model.enums.AuthConfigAccessModeEnum;
import io.rancher.type.OwnerReference;

public class AuthConfig extends AbstractType {
    
    private AuthConfigAccessModeEnum accessMode;
    ...
    public AuthConfigAccessModeEnum getAccessMode() {
        return this.accessMode;
    }

    public void setAccessMode(AuthConfigAccessModeEnum accessMode) {
