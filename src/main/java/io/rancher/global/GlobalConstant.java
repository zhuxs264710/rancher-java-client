package io.rancher.global;


import io.rancher.utils.DatabaseType;
...
public class GlobalConstant {
    ...
    public static String DEPLOY_NAME_STR = "deployName";
    ...
    public static String RC_NAME_PREFIX = "iecas-";
    ...
    public static String INGRESS_NAME_PREFIX = "ing-";
    public static String INGRESS_NAME_SUFFIX = "-ingress";
    ...
    public static String SECRET_NAME_PREFIX = "iecas-";
    public static String SECRET_NAME_SUFFIX = "-secret";
    ...
    public static String SHIRO_REDIS_PWD = "SHIRO_REDIS_PASSWORD";
    ...
    public static String PORTAL_MYSQL_PWD = "MYSQL_PORTAL_PASSWORD";
    ...
    public static String GRAPH_MYSQL_PWD = "MYSQL_GRAPH_PASSWORD";
    ...
    public static String getDeployName(String deployName){
        return "iecas-"+deployName+"-deploy";
    }

    public static String getServiceName(String serviceName){
        return "iecas-"+serviceName+"-svc";
    }

    public static String getSecretName(String secretName){
        return "iecas-"+secretName+"-secret";
    }

    public static String getIngressName(String ingressName){
        return "iecas-"+ingressName+"-ing";
    }

    public static String getEndpointName(String endpointName){
        return "iecas-"+endpointName+"-svc";
    }

    public static String getHPAName(String hpaName){
        return "iecas-"+hpaName+"-hpa";
    }

    public static String getLoadBalanceName(String lbName){
        return "iecas-withlb-"+lbName+"-lb";
    }

    public static String getReplicationControllerName(String rcName){
        return "iecas-"+rcName+"-rc";
    }

    public static String getConfigMapName(String cpName){
        return "iecas-"+cpName+"-cp";
    }
